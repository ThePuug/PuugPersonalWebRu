...
import { Button, Card, CardActions, CardContent, CardHeader, CardMedia, Container, IconButton, Paper, Stack, styled, Typography, List, ListItem, ListItemText } from '@material-ui/core'
import { Attachment, Facebook, LinkedIn } from "@material-ui/icons"
    ...
    <Container maxWidth="md">
      <Stack spacing={2}>
        ...
        <Paper css="padding:1rem">
            <Profile elevation={4} css="float:left; margin:0 1rem 1rem 0">
              <CardHeader title={t('profile.name')} />
              <CardHeader title={t('profile.title')} />
              <CardMedia css="text-align:center">
        ...
        <Paper css="padding:1rem">
          ...
          <List dense disablePadding>
            {t('content.qualifications',{returnObjects:true}).map((p,i) => <ListItem key={i} css={{padding:"0px"}}><ListItemText><Typography variant="body1">{p}</Typography></ListItemText></ListItem>)}
          </List>
        </Paper>
      </Stack>
    </Container>
